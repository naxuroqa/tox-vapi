...
namespace ToxCore {
  ...
  public class Tox {
    ...
    public void friend_send_lossy_packet(uint32 friend_number, uint8[] data, ref ErrFriendCustomPacket error);

    public void friend_send_lossless_packet(uint32 friend_number, uint8[] data, ref ErrFriendCustomPacket error);
